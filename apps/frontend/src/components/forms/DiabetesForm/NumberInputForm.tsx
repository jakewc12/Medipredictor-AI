...
const StyledButton = styled('button')(
  ...
  border-color: ${theme.palette.mode === 'light' ? grey[800] : grey[200]};
  background: ${theme.palette.mode === 'light' ? grey[900] : grey[50]};
  color: ${theme.palette.mode === 'light' ? grey[200] : grey[900]};
  }
